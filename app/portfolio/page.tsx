    ...
    >
      {videos.map((v, i) => (
        <VideoCell
          ...
          style={{ height: cols === "mobile" ? "240px" : "350px" }} // ← taller on desktop
          delay={i * 0.1}
        />
      ))}
    </div>
...
function SangeetChapter() {
  ...
  return (
    <section id="chapter-sangeet" style={{ marginBottom: "88px" }}>
      <ChapterHeader num="03" label="The Sangeet" accent={ACCENT} />
      <BentoTop
        accent={ACCENT}
        num="03"
        label="The Sangeet"
...
function HaldiChapter() {
  ...
  return (
    <section id="chapter-haldi" style={{ marginBottom: "88px" }}>
      <ChapterHeader num="04" label="The Haldi" accent={ACCENT} />
      <BentoTop
        accent={ACCENT}
        num="04"
        label="The Haldi"
...
// https://res.cloudinary.com/dxxvbrgie/video/upload/v1772785635/Mantapa_ocuzuk.mp4
// https://res.cloudinary.com/dxxvbrgie/video/upload/v1772785612/vid5_cw9wrh.mp4
...
function CarnivalChapter() {
  ...
  return (
    <section id="chapter-carnival" style={{ marginBottom: "60px" }}>
      <ChapterHeader num="06" label="The Carnival" accent={ACCENT} />
      <BentoTop
        accent={ACCENT}
        num="06"
        label="The Carnival"
...
function VarapoojaChapter() {
  const ACCENT = "#b8908a";
  return (
    <section id="chapter-varapooja" style={{ marginBottom: "60px" }}>
      <ChapterHeader num="05" label="The Varapooja" accent={ACCENT} />
...
const NAV = [
  ...
  { id: "chapter-varapooja", label: "Varapooja" },
];
